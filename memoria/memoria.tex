...
%		(INCOMPLETO)
	...
	% Añadir referencias y ejemplos!! Dar contexto, hablar de lo que hay alrededor
	% "Este TFG se encuadra al rededor de una plataforma digital para enseñar robótica" para q se sepa xk se va a hablar de todo
	%	
	...
	\label{sec:plataformas_digitales}
		% Ejemplificar con plataformas digitales, "las tecnologias web cada vez resuelven mas funcionalidad y aplicaciones para las personas... Ha habido una revolucion enorme con HTML 5 y todas las tecnologías que van de la mano: websockets, webworkers..."
		
		% Impacto de las tecnologías web en la vida de las personas
		% plataformas digitales - subscripciones
		
		% paginas web y sus subscriptores
	
		% incluye monitorizacion
